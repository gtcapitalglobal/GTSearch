...
// ========================================
// FLORIDA COUNTIES ENDPOINT
// ========================================

/**
 * Returns Florida county appraisal links (static data from florida-counties.js)
 * Used by florida-counties-api.js in the frontend
 */
app.get('/api/florida-counties', (req, res) => {
  ...
  res.json({ success: true, counties: FLORIDA_COUNTIES, count: Object.keys(FLORIDA_COUNTIES).length, cached: false });
});
